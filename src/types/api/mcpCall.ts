...
/** The known codes. Written as an open union: the frontend never branches on the whole
 *  list — it forwards whatever the backend sends — and the backend will add to it. Only
 *  the two `REPAIR` ones below are read by name. */
