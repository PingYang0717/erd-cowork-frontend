...
describe('Chat composer', () => {
  ...
  /** The mockup hard-coded "Inline DB · PT-07 line" here — a claim about what the
   ...
   *  is decided. */
  /** The thread header names the pane and nothing else. It used to carry the theme and
   *  language toggles as well; those are preferences about the app rather than about
   *  this conversation, and they live behind the app header's avatar now. The
   *  data-source chip the mockup hard-coded ("Inline DB · PT-07 line") is still
   *  deliberately absent — it asserted a fact the Connectors panel could flatly
   *  contradict. */
  it('keeps the thread header to identity alone', async () => {
    ...
    // The preferences are still reachable — from the app header, once.
