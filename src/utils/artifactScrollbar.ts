 ...
 *  Artifact can still override from its body, which is its business. Parsed, not
 *  pattern-matched, for the reasons `injectCspMeta` gives. */
export const injectScrollbarStyle = (html: string): string => {
