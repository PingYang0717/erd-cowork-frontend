          ...
          <div key={field.key} className={styles.field}>
            ...
            {field.kind === 'text' ? (
              ...
              <Select
                ...
                virtual={false}
                // Its own flag, not just the fieldset's: antd draws a tag's remove `×` as
                // a span, and a disabled fieldset does not reach spans. A settled card
                // would show a control that looks like it takes the answer back.
                disabled={disabled}
