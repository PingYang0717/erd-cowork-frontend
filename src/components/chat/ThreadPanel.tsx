      ...
      {hasContent ? (
        ...
        <div className={styles.body}>
          <EmptyState
            ...
            subtitle={'Try "Daily monitor (PT-01)" below, or ask for an SPC analysis on Vt.'}
          />
        </div>
      )}
