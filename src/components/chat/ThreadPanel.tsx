...
const ThreadHeader: React.FC = () => {
  return (
    <header className={styles.header} aria-label="Thread header">
      ...
      {/* No data-source chip here: the mockup hard-coded "Inline DB · PT-07 line", which
...
const ThreadView: React.FC<ThreadViewProps> = ({ sessionId }) => {
  ...
  // that is the backend gap, made visible rather than papered over — see the backend
  // feedback list, kept outside this repo.)
