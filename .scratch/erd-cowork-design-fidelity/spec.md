...
11. As an RD engineer, I want to see a data-source chip (e.g. "Inline DB · PT-07 line") next to the theme toggle in the thread header, so that I know what data this conversation/Scenario is scoped to.
