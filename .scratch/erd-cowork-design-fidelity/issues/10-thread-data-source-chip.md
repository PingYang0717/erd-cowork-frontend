...
- [ ] Thread header shows a data-source chip (e.g. "Inline DB · PT-07 line": database icon, fs11.5, border-secondary, br7, pad 3 8) reflecting the current session/Scenario's data source
