...
7. As an RD engineer, I want to click a suggested prompt button (Inline dashboard / SPC analysis / Generate slides / Daily monitor (PT-01) / CP Test status), so that I can trigger a common analysis without typing.
