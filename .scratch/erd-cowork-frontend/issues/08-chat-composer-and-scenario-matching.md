...
- [x] Composer accepts free-text input and exposes the five suggested-prompt buttons (Inline dashboard / SPC analysis / Generate slides / Daily monitor (PT-01) / CP Test status)
