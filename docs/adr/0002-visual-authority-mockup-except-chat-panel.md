...
**圓窗與錦鯉拿掉了。** 不是它畫得不好,是它跟這個世界無關;要留它,就得把它的畫法也改成 header
的,而那樣它就只是地面上再多一條魚。前四版被否決的理由(上一段)仍然成立:這一版的地面**不是**
被否決的第一版——那一版是把側邊欄那塊家具搬到置中標題底下;現在的地面是整個視窗的地,標題只是
站在上面。

**判準。** 能不能一眼看出「這些是同一個地方」:雪從同一片天落到每個面、地面在欄位邊界對得上、
馴鹿從對話欄後面走出來繼續走。做不到其中一條,就是又回到東一塊西一塊。
