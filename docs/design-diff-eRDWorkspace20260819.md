...
| 功能 | Thread header 資料來源 chip    | 右側有「Inline DB · PT-07 line」chip(database icon,fs11.5、border-secondary、br7、pad 3 8)                                                                                                                                                                                                                           | 無此 chip;該位置放了 ThemeToggle                                                                                                    | 目前資料來源資訊在 Studio 無處顯示                                      | 中(ThemeToggle 位置屬 scope 調整,chip 缺失待確認) |
